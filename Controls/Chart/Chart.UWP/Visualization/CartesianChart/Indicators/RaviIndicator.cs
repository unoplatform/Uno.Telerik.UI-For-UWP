...
{
    /// <summary>
    /// Visualizes a collection of DataPoints, using a <see cref="Microsoft.UI.Xaml.Shapes.Line"/> shape. This class represents the Range Action Verification Index financial indicator.
    /// </summary>
