...
namespace Telerik.UI.Xaml.Controls.Primitives.Menu.Commands
{
    ...
    /// </summary>
    public sealed class RadialMenuUserCommand : RadialMenuCommand
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the default command implementation, related to the current <see cref="CommandId"/>, should be executed.
        /// </summary>
        /// <value>
        ...
        {
            var command = d as RadialMenuUserCommand;
