...
namespace Telerik.UI.Xaml.Controls.Data.ListView.Commands
{
    ...
    /// </summary>
    public sealed class ListViewUserCommand : ListViewCommand
    {
        /// <summary>
        /// Identifies the <see cref="Command"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty CommandProperty =
            DependencyProperty.Register(nameof(Command), typeof(ICommand), typeof(ListViewUserCommand), new PropertyMetadata(null, OnCommandChanged));
        ...
        public static readonly DependencyProperty EnableDefaultCommandProperty =
            DependencyProperty.Register(nameof(EnableDefaultCommand), typeof(bool), typeof(ListViewUserCommand), new PropertyMetadata(true, OnEnableDefaultCommandChanged));
        ...
        {
            var command = d as ListViewUserCommand;
