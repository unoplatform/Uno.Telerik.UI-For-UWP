...
namespace SDKExamples.Calendar
{
    ...
    public sealed partial class MultiDayView : ExamplePageBase
    {
        ...
        private void ScrollToAppointmentBtnClicked(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            ...
            if (this.scrollToTb.Visibility == Microsoft.UI.Xaml.Visibility.Collapsed)
            {
                this.scrollToTb.Visibility = Microsoft.UI.Xaml.Visibility.Visible;
            }

            this.scrollToTb.Text = "Scrolled to: " + app.Subject;
        }

        private void ChangeViewBtnClicked(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
        ...
        {
            if (this.calendar.DayNamesVisibility == Microsoft.UI.Xaml.Visibility.Collapsed)
            {
                this.calendar.DayNamesVisibility = Microsoft.UI.Xaml.Visibility.Visible;
            }
            else
            {
                this.calendar.DayNamesVisibility = Microsoft.UI.Xaml.Visibility.Collapsed;
            }
        }
